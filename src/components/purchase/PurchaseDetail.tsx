...
import { Package, Calendar, User, FileText, Printer, Edit, X, CheckCircle2 } from 'lucide-react'
...
function PurchaseDetail({ order, onEdit, onPrint, onClose }: PurchaseDetailProps) {
  const { getSupplier } = useContactStore()

  // 获取供应商信息
  const supplier = useMemo(() => {
    return getSupplier(order.supplierId)
  }, [order.supplierId, getSupplier])
  ...
  // 判断是否已完成入库
  const isCompleted = order.status === '已入库'
    ...
    <div className="bg-white rounded-2xl shadow-xl w-[1152px] max-h-[90vh] flex flex-col">
      ...
      <div className="flex items-center justify-between px-6 py-6 border-b border-gray-200">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-2xl font-semibold text-gray-900">进货单详情</h2>
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-xl p-6">
          ...
          <div className="grid grid-cols-4 gap-x-8 gap-y-4 mb-4">
            ...
            <div>
              ...
              <div className="text-base text-gray-900">{order.supplierName}</div>
            </div>
            
            {/* 联系人 */}
            <div>
              <div className="text-sm text-gray-600 mb-1">联系人</div>
              <div className="text-base text-gray-900">{supplier?.contactPerson || '-'}</div>
            </div>
            
            {/* 联系电话 */}
            <div>
              <div className="text-sm text-gray-600 mb-1">联系电话</div>
              <div className="text-base text-gray-900">{supplier?.phone || '-'}</div>
            </div>
            ...
            {/* 进货日期 */}
            <div>
              <div className="text-sm text-gray-600 mb-1">进货日期</div>
              <div className="flex items-center gap-2">
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-xl p-6">
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="space-y-3 border-l border-gray-200 pl-6">
              ...
              <div className="flex justify-between items-center">
                <span className="text-base text-gray-600">已付金额：</span>
